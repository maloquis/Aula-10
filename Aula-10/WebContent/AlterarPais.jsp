                    ...
                    <form action="controller.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" name="populacao" id="populacao" maxlength="15" placeholder="populacao" value="${pais.populacao }">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="area">Area</label>
                                <input class="form-control" name="area" id="area" required maxlength="60" placeholder="area" value="${pais.area }">
                            </div>
                        </div>
                        <hr />
